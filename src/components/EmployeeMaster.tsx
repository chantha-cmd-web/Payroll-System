...
import { 
  Plus, Search, Edit2, Trash2, X, Check, Save, Filter, UserCheck, ChevronRight, 
  MapPin, Briefcase, FileText, Globe, Upload
} from 'lucide-react';
  ...
  const handleDownloadTemplate = () => {
    ...
    if (activeTab === 'Full-Time') {
      ...
      headers = [
        ...
        'Spouse', 'Kids', 'Allowance', 'SD Return', 'Adjust Error TOS/NSSF', 'Work Book (-)',
        'Bank Acc', 'Email', 'Remarks', 'Status', ...typeSuffix
      ];
    } else {
      headers = [
